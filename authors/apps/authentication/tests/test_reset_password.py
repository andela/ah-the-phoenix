...
class TestEmailPasswordReset(BaseTest):
    ...
    def test_successful_email_sending(self):
        ...
        self.assertIn(
            b'A password reset link has been sent to your email',
            response.content)
    ...
    def test_if_user_email_exists(self):
        ...
        self.assertIn(
            b"A user with the given email was not found", response.content)
...
class TestEmailPasswordUpdate(BaseTest):
    ...
    def test_password_reset_valid_password(self):
        ...
        self.assertIn(
            b'Your password has successfully been reset', response.content)
